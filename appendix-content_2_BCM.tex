...
Then the definition of the chemical potential is:
\begin{equation}\mu_{i} = \left(\frac{\partial G}{\partial n_{i}}\right)_{T,P,n_{j \neq i}}\end{equation}\\*

Where $\mu_i$ is the chemical potential of component $i$, $n_i$ refers to a molecule of component $i$ and $n_{j \neq i}$ refers to all molecules other than component $i$.\\*
...
Excess molar enthalpy can be calculated using the general relation of molar enthalpy as it relates to Gibbs Free Energy from section $A.1$ and the generalized method of ecess molar property calculation above or by the following:
